        ...
        if not filtered_titles:
            ...
            with col5:
                ...
                if tag_counts:
                    ...
                    # 웹 폰트 사용 (Noto Sans CJK KR - 구글 폰트)
                    try:
                        # 먼저 시스템에 설치된 한글 폰트 시도
                        wordcloud = WordCloud(
                            width=500,
                            height=300,
                        ...
                        # Noto Sans CJK KR 폰트 다운로드
                        font_url = "https://fonts.googleapis.com/css2?family=Noto+Sans+KR:wght@400;700&display=swap"
                        try:
                            response = requests.get("https://github.com/googlefonts/noto-cjk/raw/main/Sans/OTF/Korean/NotoSansCJKkr-Regular.otf")
                            ...
                            st.warning(f"폰트 로딩 실패: {e}. 기본 폰트로 대체됩니다.")
                            wordcloud = WordCloud(
                                width=500,
                                height=300,
                                background_color="white",
